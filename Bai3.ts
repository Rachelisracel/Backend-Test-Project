...
try {
  const result = calcInvoice(
    "MONTHLY",  // courseType
    1000000,    // basePrice (1 triệu/tháng)
    3,          // months (Học 3 tháng)
    "SAVE10",   // promoCode (Giảm 10%)
    2,          // canceledClasses (Hủy 2 buổi)
    20000       // refundPerClass (Hoàn 20k/buổi)
  );

  console.log("=== HÓA ĐƠN HỌC PHÍ ===");
